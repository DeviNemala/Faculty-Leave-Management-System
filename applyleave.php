...
<html>
<head>
	<title>Apply Leave | Employee Panel | Faculty Leave System</title>
                ...
                <div class="card-body">
                    ...
                    <form action="process/applyleaveprocess.php?id=<?php echo $id?>" method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" name="Name" value="<?php echo $firstname;?>.<?php echo $lastname;?>" readonly>
                        </div> 
                        <div class="input-group">
                        ...
                        <div class="row row-space">
                          ...
                          <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Faculty Assaign" name="faculty" required>
                        </div>   
                        </div>
